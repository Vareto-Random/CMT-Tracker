...
def main():
    ...
    print('VARpool(../video_tennis/, 1000, [[405, 160],[255, 100],[340,80]], [[450, 275],[275, 155],[355,115]])')
    VARmethod('../video_tennis/', 1000, [[405, 160],[255, 100],[340,80],[270,80]], [[450, 275],[275, 155],[355,115],[280,103]])
    print('VARpool(../video_tennis/, 1000, [[405, 160],[255, 100],[340,80],[245,75]], [[450, 275],[275, 155],[355,115],[253,99]])')
...
def VARmethod(folder_path, final_frame, top_left, bot_right):
    ...
    if len(top_left) == len(bot_right):
        ...
        for index in range(0, len(top_left)):
            ...
            worker(folder_path, list_name, top_left[index], bot_right[index], index)
        # pool.close()
        # pool.join()
